...
$(function() {
  ...
  populateButtons(
    searchArray,
    "searchButton btn btn-outline-secondary my-10 my-sm-10 rounded-pill border-0",
    "#buttonsArea"
  );
});
...
$(document).on("click", ".searchButton", function() {
  ...
  var queryURL =
    ...
    type +
    "&api_key=voNnyyTExK7FTKloLeSv3jG4vp3OwJne&limit=20";
  ...
  $.ajax({
    ...
    for (var i = 0; i < response.data.length; i++) {
      ...
      var searchDiv = $(`<div class="search-item card">`);
...
// to fix click on image and stop the animation and click back on to start it again
